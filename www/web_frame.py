...
# http://echo.com/post/python/pythonzhuang-shi-qi-ying-yong
...
class RequestHandler(object):  # 初始化一个请求处理类
    ...
    def __call__(self, request):
        ...
        if self._has_var_kw_arg or self._has_named_kw_args or self._required_kw_args:
            ...
            #
            # POST提交请求的类型(通过content_type可以指定)可以参考我的博客：http://echo.com/post/python/postchang-jian-qing-qiu-fang-shi-qian-xi
...
def add_routes(app, module_name): 
    ...
    logging.info('n = %s', n)
    # 没有'.',则传入的是module名
    # __import__方法使用说明请看：http://echo.com/post/python/python-de-nei-zhi-han-shu-__import__
    if n == (-1):
