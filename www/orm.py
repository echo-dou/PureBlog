...
def select(sql, args, size=None):
    ...
    # with语句用法可以参考我的博客：http://echo.com/post/python/pythonzhong-de-withyu-ju-shi-yong
...
class Model(dict, metaclass=ModelMetaclass):
    ...
    def getValue(self, key):
        ...
        # 获取实例的key，None是默认值，getattr方法使用可以参考http://echo.com/post/python/pythonzhong-de-nei-zhi-han-shu-getattr-yu-fan-she
